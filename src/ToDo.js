...
export default function ToDo({ author, title, description , dateCreated, dateCompleted, completed, id, updateTask, deleteTask }){
    ...
    const handleCheckbox = (event) => {
        ...
        const updatedTask = {author, title, description ,dateCreated, id, dateCompleted: Date.now(), completed: !completed}
